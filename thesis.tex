...
\begin{appendices}	
	...
	\section*{Appendix B: Electronic resources}
	
	An electronic copy of this report in PDF form can be found at \\ \url{https://github.com/MJHutchinson/Masters-Thesis/blob/master/thesis.pdf}
	
	\noindent The logbook for this report can be found at\\
	\url{https://drive.google.com/open?id=1WmDSJNPokp8066bDTlEK9_Jf_sLVfS5o}\\
	and in the commit logs of\\
	\url{https://github.com/MJHutchinson/BayesMLP}\\ and\\
	\url{https://github.com/MJHutchinson/GPAR_Architecture_Search}
\end{appendices}
