...
% Crest minimum should be 30mm.
\collegeshield{\includegraphics[width=0.2\textwidth]{CollegeShields/StJohns}}
...
\renewcommand{\submissiontext}{I hereby declare that, except where specifically indicated, the work submitted herin is my own original work.
\vspace{2cm}
\\
